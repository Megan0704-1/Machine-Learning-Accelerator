...
batch_size = args.batch  # Batch size for training and testing TODO: Modify this variable to change batch size
log_interval = (
...
class SimpleCNN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 1, 5) # input channels = 1, output channels = 1, kernel_size = 5
